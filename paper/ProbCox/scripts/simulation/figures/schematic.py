...
fig, ax = plt.subplots(3, 1, figsize=(8.27*0.9, 11.69/2), dpi=600, sharex=True)
...
ax[2].text(1475, 0.0074, r'$p(t=T) > U(0, 1)$')
...
plt.savefig('./out/simulation/figures/schematic.eps', bbox_inches='tight', dpi=600)
