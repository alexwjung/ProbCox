...
for suffix in ['rank10_ST1_0.001', 'rank100_ST1_0.001', 'rank10_ST2_0.01', 'rank10_ST4_0.1', 'rank10_L0.5', 'rank10_L0.25', 'rank10_L0.1']:
...
, W, col_idx)
    ...
    pd.DataFrame(np.concatenate((res[:10, :], res[250:260, :]))).to_csv('./out/simulation/tables/' + sim_name + '_ProbCox_main_' + suffix + '.csv')

    theta_est_lower = theta_bound[:, :500]
    theta_est_upper = theta_bound[:, 500:]
