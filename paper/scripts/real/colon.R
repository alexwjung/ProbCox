...
write.csv(colon, './data/real/colon.csv')
...
write(x, file='./output/real/colon/R_theta.txt', ncolumns = 1, append = FALSE, sep = ";")

x = paste(sqrt(diag(m$var)), collapse="; ")
write(x, file='./output/real/colon/R_se.txt', ncolumns = 1, append = FALSE, sep = ";")

x = paste(unname(m$concordance['concordance']), collapse=" ")
write(x, file='./output/real/colon//R_concordance.txt', ncolumns = 1, append = FALSE, sep = ";")
